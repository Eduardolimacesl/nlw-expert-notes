...
export function NewNoteCard({onNoteCreated}: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    if (isSpeechRecognitionAPIAvailable === false) {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 tp-1/2 mmd:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 flex flex-col md:rounded-md outline-none">
